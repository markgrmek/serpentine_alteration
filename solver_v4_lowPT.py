...
for time_step in range(N_steps):
    ...
    if time == time_tot or time_step==(N_steps-1):
        ...
        savetxt(fname=f'grid_lowPT.csv', X=x, delimiter=',', fmt='%f')
        savetxt(fname=f'time_lowPT.csv', X=time_output, delimiter=',', fmt='%.18e')
        savetxt(fname=f'wCO2_s_lowPT.csv',X=wCO2_s_output,delimiter=',',fmt='%.18e')
        savetxt(fname=f'wCO2_fl_lowPT.csv',X=wCO2_fl_output,delimiter=',',fmt='%.18e')
        savetxt(fname=f'por_lowPT.csv',X=por_output,delimiter=',',fmt='%.18e')
        savetxt(fname=f'density_lowPT.csv',X=density_output,delimiter=',',fmt='%.18e')
        savetxt(fname=f'wSiO2_s_lowPT.csv',X=wSiO2_s_output,delimiter=',',fmt='%.18e')
        savetxt(fname=f'wH2O_s_lowPT.csv',X=wH2O_s_output,delimiter=',',fmt='%.18e')
        savetxt(fname=f'dolomite_lowPT.csv',X=dolomite_output,delimiter=',',fmt='%.18e')
        savetxt(fname=f'antigorite_lowPT.csv',X=antigorite_output,delimiter=',',fmt='%.18e')
        savetxt(fname=f'talc_lowPT.csv',X=talc_output,delimiter=',',fmt='%.18e')
        savetxt(fname=f'magnesite_lowPT.csv',X=magnesite_output,delimiter=',',fmt='%.18e')
        savetxt(fname=f'chlorite_lowPT.csv',X=chlorite_output,delimiter=',',fmt='%.18e')
        savetxt(fname=f'quartz_lowPT.csv',X=quartz_output,delimiter=',',fmt='%.18e')
        savetxt(fname=f'magnetite_lowPT.csv',X=magnetite_output,delimiter=',',fmt='%.18e')
        savetxt(fname=f'hematite_lowPT.csv',X=hematite_output,delimiter=',',fmt='%.18e')
        savetxt(fname=f'lime_lowPT.csv',X=lime_output,delimiter=',',fmt='%.18e')
        savetxt(fname=f'calcite_lowPT.csv',X=calcite_output,delimiter=',',fmt='%.18e')
        break
